...
@Component({
  ...
  template: `
    @if (toastService.currentToast()) {
      <div 
        class="toast-overlay"
        [class.toast-visible]="toastService.isVisible()"
      >
        <div class="toast-card" [ngClass]="'toast-' + toastService.currentToast()!.type">
          <div class="toast-icon">
            @if (toastService.currentToast()!.type === 'success') {
            ...
            } @else if (toastService.currentToast()!.type === 'error') {
          ...
          <p class="toast-msg">{{ toastService.currentToast()!.message }}</p>
          <button class="toast-close" (click)="toastService.close()">
